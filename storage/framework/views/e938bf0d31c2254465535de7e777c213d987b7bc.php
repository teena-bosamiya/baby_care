...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav mx-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/user_cart')); ?>">View Your Older</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="container">
                    <div class="main-content">
                        ...
                        <a class="logo" href="index.html">
                            ...
                            <a href="<?php echo e(url('/contact')); ?>" class="btn btn-style btn-secondary mt-md-5 mt-4">Contact Us</a>
                        </div>
    ...
    <!--//Banner-End-->
<?php /**PATH C:\xampp\htdocs\baby_care\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>