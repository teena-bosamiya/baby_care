            ...
            <div class="container py-md-5">
                ...
                <div class="top-map">
                    <div class="map-content-9">
                        <form method="post" action="<?php echo e(url('/')); ?>/insert_contact_info">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-top1">
                                ...
                                <div class="form-top">
                                    <div class="form-top-right" style="margin-bottom: 20pt;">
                                        <input type="text" class="form-group" name="name" id="Name" value="<?php echo e(old('name')); ?>" placeholder="Name" required="">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-top-right" style="margin-bottom: 20pt;">
                                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" id="Sender" placeholder="Email*" required="">
                                        <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-top-right" style="margin-bottom: 20pt;">
                                        <input type="text" name="subject" value="<?php echo e(old('subject')); ?>" placeholder="Your Subject" required="">
                                        <span class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-top-righ">
                                        ...
                                        <textarea name="messege" id="Message" placeholder="Message*" required=""><?php echo e(old('messege')); ?> </textarea>
                                        <span class="text-danger">
                                            <?php $__errorArgs = ['messege'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('frontend.layouts.all_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\baby_care\resources\views/frontend/contact.blade.php ENDPATH**/ ?>