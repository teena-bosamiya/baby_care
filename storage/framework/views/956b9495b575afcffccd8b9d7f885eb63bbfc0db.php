            ...
            <div class="row align-items-center">
                <div class="col-lg-6 pe-lg-5">
                    ...
                    <ul class="service-list pt-lg-2 mt-4">
                        ...
                        <li class="service-link">
                            <a href="cat_product/<?php echo e($data->cat_id); ?>">
                                <img src="<?php echo e(URL('backend/images/category/'. $data->cat_img)); ?>" alt="" style="width: 20px; height:20px;" >
                ...
                <div class="HomeAboutImages col-lg-6 mt-lg-0 mt-5">
                    <div class="row position-relative">
                        <div class="col-6">
                            <img src="<?php echo e(url('frontend/images/baby.jpg')); ?>" style="margin-top: 130px;" alt="" class="radius-image img-fluid">
                        </div>
                        <div class="col-6 mt-4">
                            <img src="<?php echo e(url('frontend/images/boy.png')); ?>" alt="" class="radius-image img-fluid mb-md-3 mb-2">
                            <img src="<?php echo e(url('frontend/images/girl.jpg')); ?>" alt="" class="radius-image img-fluid mt-md-3">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grids-of-3 row text-center">
                 ...
                 <div class="col-lg-4 col-md-6 mt-5">
                    <div class="grids3-info">
                        <a href="brand_product/<?php echo e($data->brand_id); ?>" class="d-block zoom"><img style="width: 400px; height:250px;" src="<?php echo e(URL('backend/images/brand/'. $data->brand_logo)); ?>" alt="" class="img-fluid radius-image"></a>
                        <div class="grids-of-3-saas-info">
                            <h5><a href="brand_product/<?php echo e($data->brand_id); ?>" class="title" style="border:1px solid black"><?php echo e($data->brand_name); ?></a></h5>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                <div class="testimonial">
                                    ...
                                    <div class="testi-des">
                                        <div class="test-img"><img src="<?php echo e(url('frontend/images/babyuser.png')); ?>" class="img-fluid" alt="client-img">
                                        </div>
            ...
            <div class="row stats-con">
                <div class="col-lg-6 stats-content-left pe-lg-5">
                    <div class="stats_info counter_grid1 text-left">
                        <div class="icon stat-icon">
                            <div class="testi-des">
                                <div class="test-img"><img src="<?php echo e(url('frontend/images/nature.jpg')); ?>" class="img-fluid" alt="client-img">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 stats-content-left ps-lg-5 mt-lg-0 mt-md-5 mt-4">
                    <div class="stats_info counter_grid1 text-left">
                        <div class="icon stat-icon">
                            <div class="testi-des">
                                <div class="test-img"><img src="<?php echo e(url('frontend/images/quality.jpg')); ?>" class="img-fluid" alt="client-img">
                                </div>
                            </div>
                        </div>
                        <div class="stat-icon-des text-left">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\baby_care\resources\views/frontend/index.blade.php ENDPATH**/ ?>