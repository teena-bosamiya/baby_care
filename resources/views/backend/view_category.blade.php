                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $data->cat_id  }}</td>
                          <td>{{ $data->cat_name  }}</td>
                          <td><img src="{{URL('backend/images/category/'. $data->cat_img)}}" style="height: 200px; width: 150px; border-radius:0px;" /></td>
                          <td><span>
                            <a href="edit_category/{{$data->cat_id}}" class="mr-4" data-toggle="tooltip"
                                   data-placement="top" title="Edit"><img src="{{URL('backend/images/edit.png')}}"><i
                                       class="fa fa-pencil color-muted"></i> </a>

                                       <a
                                   href="delete_category/{{$data->cat_id}}" data-toggle="tooltip"
                          ...
                          <td><label class="badge">
                            ...
                            <span>
                                <a href="change_cat_status/{{$data->cat_id}}" class="mr-4" data-toggle="tooltip"
